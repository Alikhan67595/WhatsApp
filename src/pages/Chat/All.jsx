...
const UserComponent = ({image, name , time , messageType}) => {
  return (
<>
<button type='button' className='group select-none flex gap-4 w-full duration-150 hover:bg-[#353636] max-[768px]:active:bg-[#1b2227cc] p-2 py-2 min-[768px]:rounded-[12px] relative overflow-x-hidden cursor-pointer'>

    <div className='size-13 max-[450px]:size-12 bg-amber-300 rounded-full p-1 bg-cover' style={{backgroundImage : `url(${image})`}}></div>
    ...
    <div className='flex flex-col justify-items-start items-end pt-1 text-[12px] max-[450px]:text-[10px] text-[#FFFFFF99]'>
      {time}
    </div>
