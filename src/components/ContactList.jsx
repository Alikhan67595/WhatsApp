...
const ContactList = () => {
    ...
    return (
        <>
            <main className='flex flex-col h-screen w-[31%] min-w-85 border-r-[1px] border-[#ffffff1a] scroll-none'>
                ...
                <header className='flex items-center pt-2 px-4 user-select-none'>
                    ...
                    <div className='flex justify-center items-center rounded-full p-[8px] m-1 hover:bg-[#2d2e2e] duration-150 cursor-pointer'><MoreIcon /></div>
                </header>
                ...
                <div className='px-6 pt-1 flex justify-start items-center gap-2 text-[14px] text-[#FFFFFF99] font-semibold'>
