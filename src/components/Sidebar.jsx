...
const Sidebar = () => {
  return (
   ...
   <NavLink  className={({isActive})=>`${(isActive ? 'bg-[#272929]' : 'hover:bg-[#272929]')} size-[40px] flex justify-center items-center rounded-full cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#21c063]`} to={'/chats'}>{({isActive})=>(isActive ? <div><ChatFocusIcon/></div> : <div><ChatUnfocusIcon/></div>)}</NavLink>
...
{/* ///////////////////////////////////////////////////////////////////////////////// */}
   ...
   <NavLink className={({isActive})=>`${(isActive ? 'bg-[#272929]' : 'hover:bg-[#272929]')} size-[40px] flex justify-center items-center rounded-full overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-[#21c063]`} to={'/profile'}>{({isActive})=>(<img className={`${isActive ? 'outline-[#dfdfdf] outline-[2px]' : 'outline-none'} size-[28px] rounded-full object-fill`} src={profileImg} alt="" />)}</NavLink>
