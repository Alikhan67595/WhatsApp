...
import { AccountCircleIcon, WebIcCheck, PencilRefreshedIcon, Mood, PhoneFillicon, CopyRefreshedIcon, MailIcon } from '../Icons/Icons.jsx'
        ...
        <>
            ...
            <div className='flex w-full max-[768px]:hidden'>
                ...
                <main className='p-2 flex flex-col h-screen max-[768px]:w-screen min-[768px]:w-[32%] min-[768px]:min-w-100 md:max-w-160   '>
                    {/* /////////////////// */}
                    <h1 className='px-3 p-2  text-[20px] font-semibold'>Profile</h1>

                    <div className='w-full py-8 flex flex-col gap-7 overflow-y-auto overflow-x-hidden z-10 relative'>
