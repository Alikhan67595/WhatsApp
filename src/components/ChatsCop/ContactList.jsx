...
const ContactList = ({ isUserChats, setIsUserChats}) => {
    ...
    return (
        <>
            <main className='relative flex flex-col h-screen w-screen min-[768px]:w-[31%] min-[768px]:min-w-85 md:max-w-140 border-r-[1px] border-[#ffffff1a] scroll-none'>
                ...
                <header className='flex items-center pt-2 px-5 max-[768px]:px-4 user-select-none'>
                    ...
                    <button className='flex justify-center items-center rounded-full p-[8px] max-[768px]:px-0 m-2 min-[768px]:hover:bg-[#2d2e2e] duration-150 cursor-pointer' onClick={()=>setIsNewChat(true)}><NewChatIcon /></button>
                ...
                <div className={`${isNewChat ? 'newChat-in' : 'newChat-out'} h-full w-full absolute bg-[#161717] z-10`}>
